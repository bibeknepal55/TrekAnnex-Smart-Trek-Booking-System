"""
Django settings for trek_annex project.
...
SECRET_KEY = 'django-insecure-=uv5-(h4ikgx%n)cwwg_og12i^7pp-^rv=5q+mc8722r8!r3vt'
...
WSGI_APPLICATION = 'trek_annex.wsgi.application'
